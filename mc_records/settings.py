"""
Django settings for mc_records project.
...
WSGI_APPLICATION = 'mc_records.wsgi.application'
...
EMAIL_POST = 587
DEFAULT_FROM_EMAIL = 'MC Records Team <mcrecords.customerservice@gmail.com>'